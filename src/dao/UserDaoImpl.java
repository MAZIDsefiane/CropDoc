...
public class UserDaoImpl implements UserDao{
	...
	public boolean register(User user,String type_user) throws NoSuchAlgorithmException, InvalidKeySpecException
	{
		 ...
		 String query = "insert into user(Id,nom,prenom,email,password,type_user) values (NULL,?,?,?,?,?)"; //Insert user details into the table 'USERS'
		 preparedStatement = con.prepareStatement(query); //Making use of prepared statements here to insert bunch of data
		 preparedStatement.setString(1, nom);
		 preparedStatement.setString(2, prenom);
		 preparedStatement.setString(3, email);
		 preparedStatement.setString(4, passwordEncryption.generateStorngPasswordHash(password));
		 preparedStatement.setString(5, type_user);
		 System.out.println(preparedStatement);
		 int i= preparedStatement.executeUpdate();
		 preparedStatement.close();
		 if (i!=0)  // data has been inserted into the database
		 {
			 //R�cuperer le ID du utilisateur qui vient d'�tre inser� 
		...
		try
		 {
            ...
            while(rs.next()) {
            	...
            	dbMail = (String) rs.getString("email");
            	if(dbMail.equals(email)) {
	            	if(passwordEncryption.validatePassword(password, dbPass)) {
	            		map(rs, user);
	            		return true;
	            	}	
            	}
	...
	@Override
	public boolean add_worker(Worker worker) throws NoSuchAlgorithmException, InvalidKeySpecException {
		...
		try
		 ...
		 con = DBConnection.createConnection();
		 System.out.println(con);
		 password = passwordEncryption.generateStorngPasswordHash(password);
